# Generated by Django 4.2.8 on 2024-01-24 15:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('own', 'Owner'), ('dis', 'Dispatcher'), ('upd', 'Updater'), ('flm', 'Fleet manager'), ('sam', 'Safety manager'), ('acc', 'Accountant'), ('gue', 'Guest')], max_length=3, null=True)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('companies', models.CharField(blank=True, max_length=4)),
                ('users', models.CharField(blank=True, max_length=4)),
                ('drivers', models.CharField(blank=True, max_length=4)),
                ('trucks', models.CharField(blank=True, max_length=4)),
                ('logs', models.CharField(blank=True, max_length=4)),
            ],
        ),
        migrations.CreateModel(
            name='Company',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('of', 'OFF duty'), ('sb', 'Sleeper berth'), ('dr', 'Driving'), ('on', 'ON duty'), ('pc', 'Persolan conveyance'), ('ym', 'Yarn move')], default='of', max_length=2)),
